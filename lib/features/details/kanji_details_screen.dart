...
import 'package:kanji_app/routing.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          SliverToBoxAdapter(
            child: SizedBox(height: AppUnit.large.value * 5), // 5 * 16.0 = 80.0
          ),
        ],
      ),
      Positioned(
        ...
        child: Center(
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: AppUnit.large.value + AppUnit.xsmall.value), // 16.0 + 4.0 = 20.0
              IconButton(
